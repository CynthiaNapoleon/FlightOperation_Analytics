# Aviation-Ripple-Effect-Analysis
Investigating the 'Ripple Effect': A SQL driven analysis of how aggressive flight scheduling impacts crew fatigue and operational safety. Leveraging Excel for data pre-processing, SQL for surfacing business questions and Tableau for executive-level storytelling, this project transforms 130k+records into a proactive risk management framework. 

## **Project Background**
In 2024, Aurora Pacific Airways (APA) hit a critical operational plateau. Despite increasing flight volumes, the network began experiencing rising volatility and a noticeable degradation in On-Time Performance (OTP). The airline's leadership recognized that the existing schedule was no longer capable of absorbing minor shocks, but they lacked a unified view of where and how operational minutes were being lost.
